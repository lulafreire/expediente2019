...
<div class='row mt-3' style="min-height: 375px;">
    <div class="col-12">
        ...
        $recebidos = mysqli_query($conn, "SELECT * from documentos where tipo = '1' AND prazo < '$hoje' AND prazo !='0000-00-00' AND resposta ='' AND unidade = '$codUnidade' ORDER by id DESC");
        ...
        $res_recebidos = mysqli_query($conn, "SELECT * from documentos where tipo = '1' AND prazo < '$hoje' AND prazo !='0000-00-00' AND resposta ='' AND unidade = '$codUnidade' ORDER by id DESC LIMIT $inicio, $oficiosPorPagina");
