...
<div class="container-fluid">
    ...
    <div class="border-bottom py-2">
        <?php
            ...
            while($o=mysqli_fetch_array($sqlOficio)) {
                ...
                $sqlEmissor = mysqli_query($conn, "SELECT * FROM contatos WHERE id = '$idEmissor'");
                while($e=mysqli_fetch_array($sqlEmissor)) {

                    $nomeEmissor  = utf8_encode($e['nome']);
                    $cargoEmissor = utf8_encode($e['cargo']);
                    $orgaoEmissor = utf8_encode($e['orgao']);
                }
            }
            
            echo "
            Ofício nº <b>$numero/$ano</b> de $dtEmissao<br>
            Emitido por: <b>$nomeEmissor</b> ($cargoEmissor - $orgaoEmissor)<br>";
    ...
    <div class="border-bottom py-3">        
        <form method="post" action="salvar-anexo-oficio-recebido.php" enctype="multipart/form-data">
