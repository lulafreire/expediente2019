        ...
        <div class="container-fluid mt-2">
            <div class="row">
                <div class="col-5">
                    <div class="row">
                        <div class="col-8">
                            <h6 style="border-bottom: 1px solid #C0C0C0; padding: 6px"><i class="far fa-envelope"></i> Emitir <b>CARTA</b></h6>
                        </div>
                        <div class="col-4">
                            <form id="form1" name="form1" method="post" action="nova-carta-html.php">
                    ...
                    <div class="row">
                        <div class="col-12">                            
                            <div class="row">
                                <div class="col-12">
                                    <label for="contato" class="mb-0">Interessado</label>
                                    <input id="contato" name="contato" class="form-control form-control-sm" type="text" placeholder="Nome do interessado" required>                                    
                                    <label for="endereco" class="mb-0">Endereço</label>
                                    <input name="endereco" class="form-control form-control-sm" type="text" placeholder="Logradouro, número, complemento, bairro" required>
                                </div>                                
                            </div>
                            <div class="row">
                                <div class="col-4">
