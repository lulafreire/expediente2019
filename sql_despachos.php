        ...
        <div class="col-12">
            ...
            while($r=mysqli_fetch_array($res_despachos)) {
                ...
                <tr>
                    ...
                    <td><a href='dompdf.php?arquivo=$arquivoHtml&nome_arquivo=DESPACHO-$numero-$anoEmissao-$siglaUnidade' target='_blanc' class='text-dark'><i class='fas fa-file-download' title='Abrir Ofício'></i></a></td>                
