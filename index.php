    ...
    * {
    ...
    if(isset($_GET['erro'])) {
        ...
        switch($erro) {
            ...
            case 1: $msgErro = "A unidade digitada não está cadastrada. Solicite o cadastro."; 
            break;
      ...
      <p class="mt-3 mb-3 text-muted"><i class="far fa-copyright fa-flip-horizontal"></i> 2019, Lula Freire (luiz.aoliveira)</p>
        ...
        <?php
            ...
            if(isset($_GET['msg'])) {
                ...
                <i class='fas fa-check'></i> <strong>Sucesso!</strong> Uma nova chave de acesso foi enviada para o e-mail cadastrado.
                </div>";
            }
