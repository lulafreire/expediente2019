...
<html lang="pt-br">
  ...
  <style type="text/css">
    ...
    <div class="container-fluid mt-2">
        ...
        <h6 style="border-bottom: 1px solid #C0C0C0; padding: 6px"><i class="fas fa-users"></i> Cadastrar CONTATO</h6>
            ...
            <div class="col-6">
                ...
                <div class="row mb-2">
                    <div class="col-10">
                        ...
                        <input type="text" name="nome" class="form-control form-control-sm" placeholder="Nome do Contato" required>
                    </div>
                    <div class="col-2">
                ...
                <div class="row">
                    <div class="col-3">
                        ...
                        <input name="telefone" class="form-control form-control-sm" type="text" placeholder="DDD-Telefone">
                    </div>
                    <div class="col-9">
                        <label for="email" class="mb-0">E-mail</label>
                        <input name="email" class="form-control form-control-sm" type="email" placeholder="E-mail">
                    </div>
                </div>                  
                <div class="row mt-2">
                    <div class="col-6">
