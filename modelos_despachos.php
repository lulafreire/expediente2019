...
<div class="container-fluid">
    <div class='row' style="min-height: 425px;">
        <div class="col-6">
            ...
            <thead>
            <tr>
                <th scope="col">Modelos de <b>DESPACHOS</b></th>                                       
            ...
            $modelos = mysqli_query($conn, "SELECT * FROM modelos WHERE tipo='DESPACHO'");
            ...
            $res_modelos = mysqli_query($conn, "SELECT * from modelos WHERE tipo='DESPACHO' ORDER by descricao ASC LIMIT $inicio, $modelosPorPagina");
        ...
        <div class="col-12">
            <nav aria-label="Navegação de página exemplo">
                <ul class="pagination pagination-sm justify-content">
                    <li class="page-item"><a class="page-link" href="modelos_despachos.php?pagina=1">Primeira</a></li>
                    <?php 
                        ...
                        for($i = 1; $i < $totalPaginas + 1; $i++) {
                            ...
                            if($i == $pagina) {
                                ...
                                echo "<li class='page-item active'><a class='page-link' href='modelos_despachos.php?pagina=$i'>$i</a></li>";

                            } else {

                                echo "<li class='page-item'><a class='page-link' href='modelos_despachos.php?pagina=$i'>$i</a></li>";
                    ...
                    ?>                
                    <li class="page-item"><a class="page-link" href="modelos_despachos.php?pagina=<?php echo "$totalPaginas"; ?>">Última</a></li>
                </ul>
            </nav>
        </div>
    </div>
