...
<body>
    ...
    <div class='expediente'>
        CARTA Nº $numero/$ano/$siglaUnidade/INSS</b>
    </div>
...
$grava = mysqli_query($conn, "INSERT INTO documentos (emissor, interessado, assunto, texto, numero, data, tipo, unidade) VALUES ('$id_emissor', '$contato', '$assunto', '$novoTexto', '$numero', curdate(), '3', '$codUnidade')");
...
header("Location: dompdf.php?arquivo=".$arquivo."&nome_arquivo=CARTA-".$numero."-".$ano."-".$siglaUnidade);
