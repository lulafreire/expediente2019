    ...
    <div class="col-12">
        ...
        while($r=mysqli_fetch_array($res_emitidos)) {
            ...
            <tr>
                ...
                <td><a href='excluir-oficio.php?id=$id&location=sql_emitidos-nr&pagina=$pagina' target='_parent' class='text-dark'><i class='far fa-trash-alt' title='Excluir'></i></a></td>
