...
<div class="container-fluid">
    <div class='row mt-3' style="min-height: 340px;">
        <div class="col-12">
            ...
            $cartas = mysqli_query($conn, "SELECT * from documentos where
            ...
            $sqlOpt11
            $sqlOpt12 ORDER by id DESC");
            $qtcartas = mysqli_num_rows($cartas);
            ...
            // Início
            $inicio = ($cartasPorPagina * $pagina) - $cartasPorPagina;

            // Selecionar para paginação
            $res_cartas = mysqli_query($conn, "SELECT * from documentos where 
            tipo = '3' AND unidade = '$codUnidade' AND interessado LIKE _utf8 '%$termo%' COLLATE utf8_unicode_ci OR 
            tipo = '3' AND unidade = '$codUnidade' AND interessado LIKE '%$termo%' OR 
            tipo = '3' AND unidade = '$codUnidade' AND assunto LIKE _utf8 '%$termo%' COLLATE utf8_unicode_ci OR 
            tipo = '3' AND unidade = '$codUnidade' AND assunto LIKE '%$termo%' OR
            ...
            tipo = '3' AND unidade = '$codUnidade' AND texto LIKE '%$termo%'
            $sqlOpt11
            $sqlOpt12 ORDER by id DESC LIMIT $inicio, $cartasPorPagina");
            while($r=mysqli_fetch_array($res_cartas)) {
                ...
                <tr>
                    ...
                    <td><a href='detalha-carta.php?id=$id' target='_parent'><i class='far fa-file-alt text-dark' title='Detalhes'></i></a></td>
                    <td><a href='editar-carta.php?id=$id' target='_parent'><i class='far fa-edit text-dark' title='Editar'></i></a></td>
                    <td><a href='dompdf.php?arquivo=$arquivoHtml&nome_arquivo=CARTA-$numero-$anoEmissao-$siglaUnidade' target='_blanc' class='text-dark'><i class='fas fa-file-download' title='Abrir Carta'></i></a></td>                
                    <td><a href='anexar-carta.php?id=$id' target='_parent' class='text-dark'><i class='fas fa-paperclip' title='Anexar documento'></i></a></td>                
                    <td><a href='excluir-carta.php?id=$id&location=sql-cartas&pagina=$pagina' target='_self' class='text-dark'><i class='far fa-trash-alt' title='Excluir'></i></a></td>                    
                </tr>";
        ...
        <div class="col-12">
            <nav aria-label="Navegação de página exemplo">
                <ul class="pagination pagination-sm justify-content-end">
                    <li class="page-item"><a class="page-link" href="sql_cartas.php?pagina=1">Primeira</a></li>
                    <?php 
                        ...
                        for($i = 1; $i < $totalPaginas + 1; $i++) {
                            ...
                            if($i == $pagina) {
                                ...
                                echo "<li class='page-item active'><a class='page-link' href='sql_cartas.php?pagina=$i'>$i</a></li>";

                            } else {

                                echo "<li class='page-item'><a class='page-link' href='sql_cartas.php?pagina=$i'>$i</a></li>";
                    ...
                    ?>                
                    <li class="page-item"><a class="page-link" href="sql_cartas.php?pagina=<?php echo "$totalPaginas"; ?>">Última</a></li>
                </ul>
            </nav>
        </div>
    </div>
