...
// Identifica a carta a ser editado
$id = $_GET['id'];

//Pesquisa os dados da carta a ser alterada
                ...
                <div class="col-5">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                <div class="col-12">
                                <form id="form1" name="form1" method="post" action="editar-carta-html.php">                                    
                                    <input id="id_carta" value="<?php echo "$id"; ?>" name="id_carta" type="hidden">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input name="endereco" value="<?php echo "$endereco"; ?>"  class="form-control form-control-sm" type="text" placeholder="Logradouro, número, complemento, bairro" required>
                                </div>                                
                            </div>
                            <div class="row">
                                <div class="col-4">
