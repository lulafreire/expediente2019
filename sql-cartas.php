...
<div class="container-fluid">
    <div class='row mt-3' style="min-height: 375px;">
        <div class="col-12">
            ...
            $despachos = mysqli_query($conn, "SELECT * from documentos where tipo = '3' AND unidade = '$codUnidade' ORDER by id DESC");
            ...
            $res_despachos = mysqli_query($conn, "SELECT * from documentos where tipo = '3' AND unidade = '$codUnidade' ORDER by id DESC LIMIT $inicio, $despachosPorPagina");
